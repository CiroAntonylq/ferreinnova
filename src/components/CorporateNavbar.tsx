        ...
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-10">
          ...
          <div className="order-2 flex items-center gap-2 lg:order-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-sky-500/30 bg-sky-500/10 px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-sky-300 transition hover:bg-sky-500/20"
            >
              <MapPin className="h-3.5 w-3.5" />
              <span className="hidden sm:inline">Nuestras Sedes</span>
            </button>
            <button
              type="button"
